...
namespace TaskManager.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        {
            //ViewData["ActiveStatus"] = new SelectList( "ModuleId", "ModuleName");
        ...
        public async Task<IActionResult> Create([Bind("ProjectId,ProjectName,ActiveStatus")] Project project)
        {
